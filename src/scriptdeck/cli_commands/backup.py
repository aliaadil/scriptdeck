...
Reads SCRIPTDECK_DB_PATH and SCRIPTDECK_STORAGE_DIR from env (via Settings
defaults: db_path="scriptdeck.db", storage_dir="storage"). For real ops the
operator must set these env vars before running `scriptdeck backup` or
`scriptdeck restore`.
"""
