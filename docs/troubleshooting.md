...
- **Container is unreachable:** publish `8765:8765` and confirm `SCRIPTDECK_HOST=0.0.0.0`.
- **Authentication always fails:** `SCRIPTDECK_BASIC_AUTH` requires `username:bcrypt_hash`, not plaintext.
